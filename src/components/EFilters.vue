<template>
  <QCard>
    <QCardSection>
      <QSelect :options="data.options.options" v-model="select" v-if="data.options"></QSelect>
      ...
      <div v-for="check in data.checks" :key="check.id">
        ...
        <template v-for="(ch, i) in check.values">
          <QCheckbox v-if="typeof  ch === 'object'"
...
import { Action, Filters } from "../utils/DataTypes";
