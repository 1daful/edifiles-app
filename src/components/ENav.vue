<template>
  <template v-if="navType ==='xTab'">
      <QItem v-for="data in menuList.links" :key="data.path"
  ...
  <template v-else>
    <template v-for="data in menuList.links" :key="data.path">
...
import { NavList, TabType } from "../utils/DataTypes";
