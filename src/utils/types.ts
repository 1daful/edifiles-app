...
import { CarouselStyle, DataPoint, HorizontalPosition, IComponent, Label, Image, Slides, VerticalPosition, ViewGuard, ComponentType, ViewSection, LabelType, Content, Icon } from "./DataTypes";
...
export function isComponentType(section: ViewSection): section is ComponentType {
    return (section as ComponentType).component !== undefined;
...
export function isLabelType(section: ViewSection): section is LabelType {
    return (section as LabelType)?.text !== undefined
    
    /*else if (typeof section === 'string') {
        status = typeof section === 'string'
    }
    return status*/
}

export function isIcon(section: ViewSection): section is Icon {
    return (section as Icon)?.icon !== undefined
}

export function isImage(section: ViewSection): section is Image {
    return (section as Image)?.src !== undefined
}

export function isContent(section: ViewSection): section is Content {
    return (section as Content)?.label !== undefined
}
